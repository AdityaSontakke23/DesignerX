# 🏠 DesignerX — LiDAR Room Scanner & 2D Floor Plan
...
### Setup
```bash
git clone https://github.com/AdityaSontakke23/DesignerX.git
cd DesignerX
open DesignerX/DesignerX.xcodeproj
```
